...
#define DEFAULT_LOCK_FILE "/var/lock/heartbeat.lock"
...
int main(int argc, char** argv) { 
  ...
  // Open the lock file or create it if it does not exist
  int lockfd = open(DEFAULT_LOCK_FILE, O_CREAT | O_RDWR, 0644); // Kist O_RDONLY, 0444 would probably suffice.
  if(0 > lockfd) {
